# Phase 5 Stage 3 Validation — Step 1: ICA n_components fix alone
...
**Isolated condition:** reference.compute_order=pre_interpolation (reference-order bug reintroduced), ica.n_components=0.99 (ICA fix applied)

**Cohort:** n=64 (this run's own QC/exclusion outcome under this isolated preprocessing condition -- not necessarily identical to Stage 3's 64-subject cohort).

## Result: NOT CORROBORATED

- PSWT features only: AUC **0.602**, 95% CI [0.315, 0.739], permutation p=0.1741
- PSWT features + nuisance: AUC 0.543, 95% CI [0.303, 0.730], permutation p=0.3284
- Nuisance only (this run's reference line): AUC 0.503, 95% CI [0.272, 0.716], permutation p=0.4826
...
| **This run — ICA n_components fix alone** | **0.602** | [0.315, 0.739] | 0.1741 |
