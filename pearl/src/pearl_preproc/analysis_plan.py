"""Frozen Phase 2 analysis plan (phase_1.md §5).

Written and committed BEFORE Phase 2 features exist; it must not change once
features are computed. Protects the project from selective reporting.
"""
